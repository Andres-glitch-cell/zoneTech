...
<head>
    ...
    <title>{{ config('app.name', 'Página Main de Laravel') }}</title>
...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <!-- Script Para Ocultar mientras se hace scroll -->
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    window.addEventListener('scroll', () => {
                        // Se ejecuta al empezar el scroll
                        el.classList.add('opacity-0', 'pointer-events-none');

                        // Limpia el temporizador para que no se muestre hasta que pare
                        clearTimeout(timeout);

                        // Se ejecuta tras 250ms de inactividad de scroll
                        timeout = setTimeout(() => {
            ...
            <div
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            Lea la documentación (está en Inglés)
